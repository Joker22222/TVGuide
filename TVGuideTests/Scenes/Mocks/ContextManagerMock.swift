...
class ContextManagerMock : ContextManagerInterface {
    ...
    init() {
        ...
        guard let modelURL = bnl.url(forResource: "TVGuideModel", withExtension: "momd"),
            let managedObjectModel = NSManagedObjectModel(contentsOf: modelURL)
            else {
                fatalError("Unable to located Core Data model")
        }
        
        let container = NSPersistentContainer(name: "TVGuideModel", managedObjectModel: managedObjectModel)
